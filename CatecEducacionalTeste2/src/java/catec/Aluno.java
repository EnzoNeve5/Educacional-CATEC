...
public class Aluno { // Declara a classe pública Aluno.
    ...
    private String instituicao; // Atributo privado para armazenar a instituição do aluno.
    ...
    public Aluno(String nome, String instituicao, String email, String senha, LocalDate dataNascimento) { // Construtor com argumentos para inicializar os atributos.
        this.nome = nome; // Inicializa o nome do aluno.
        this.instituicao = instituicao; // Inicializa a instituição do aluno.
    ...
    public String getInstituicao() { return instituicao; } // Método getter para a instituição do aluno.
    public void setInstituicao(String instituicao) { this.instituicao = instituicao; } // Método setter para a instituição do aluno.
