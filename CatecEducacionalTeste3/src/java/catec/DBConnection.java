...
public class DBConnection { // Declara a classe pública DBConnection para gerenciar a conexão com o banco de dados.
    ...
    private static final String URL = "jdbc:postgresql://localhost:5432/postgres"; // Define a URL de conexão com o banco de dados PostgreSQL.
    private static final String USER = "postgres"; // Define o nome de usuário para a conexão com o banco de dados.
    private static final String PASSWORD = "04/04/2023"; // Define a senha para a conexão com o banco de dados.
