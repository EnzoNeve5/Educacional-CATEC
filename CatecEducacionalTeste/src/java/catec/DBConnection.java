...
public class DBConnection { // Declara a classe pública DBConnection para gerenciar a conexão com o banco de dados.
    ...
    private static final String URL = "jdbc:postgresql://localhost:5432/seu_banco_de_dados"; // Substitua pelo nome do seu banco // Define a URL de conexão com o banco de dados PostgreSQL.
    private static final String USER = "postgres"; // Ex: 'postgres' (usuário padrão) // Define o nome de usuário para a conexão com o banco de dados.
    ...
    public static Connection getConnection() throws SQLException { // Método estático para obter uma conexão com o banco de dados.
        try {
            Class.forName("org.postgresql.Driver"); // Driver específico do PostgreSQL // Carrega o driver JDBC do PostgreSQL.
